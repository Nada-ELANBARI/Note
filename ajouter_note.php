...
if(isset($_POST['btn']))
{
  ...
  if(empty($_POST['matiere']) and empty($_POST['note']))
 {
...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
  ...
  $sql2 = 'INSERT INTO notes VALUES ("'.$_POST['id'].'","'.$_POST['matiere'].'","'.$_POST['note'].'")'; 
 
 $db->exec($sql2);        
 
echo '<div class="alert bg-success" role="alert">
          <svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Votre modification est bien enregistre! <a href="#" class="pull-right"></a>
        </div>'; 
 } 
}
...
?>
         ...
         <div class="form-body">
              ...
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="matiere"  class="form-control" type="text" placeholder="Matiere">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>
