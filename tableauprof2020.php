...
<div class="row">
			...
			echo "<a href=\"supprimerprof2020.php?id=".$c['nom']."\" class=\"btn btn-danger\">Supprimer</span>" ;
		...
		<span><a href="ajouterprof2020.php" class="btn btn-info col-xs-6 col-sm-4 col-lg-2" >Ajouter Nouveau Professeur</a></span>
