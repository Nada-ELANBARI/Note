...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
  ...
  $sql2 = 'INSERT INTO module VALUES ("'.$_POST['id'].'","'.$_POST['module'].'","'.$_POST['heure'].'","'.$_POST['coef'].'","'.$_POST['annee-scolaire'].'")'; 
         ...
         <div class="form-body">
            ...
            <div class="form-group" >
              ...
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="annee-scolaire"  class="form-control" type="text" min="0" max="100" placeholder="Annee Scolaire">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="coef"  class="form-control" type="text" min="0" max="100" placeholder="Coefficient">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>   
