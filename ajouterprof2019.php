...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
  ...
  $sql2 = 'INSERT INTO prof2019 VALUES ("'.$_POST['id'].'","'.$_POST['nom'].'","'.$_POST['prenom'].'","'.$_POST['cin'].'","'.$_POST['tel'].'","'.$_POST['matiere_ens'].'","'.$_POST['password'].'")'; 
 
 $db->exec($sql2);        
 
echo '<div class="alert bg-success" role="alert">
          <svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Votre professeur est bien enregistre! <a href="#" class="pull-right"></a>
        </div>'; 
 } 
}
...
?>
         ...
         <div class="form-header " >
         	<h3 class="form-title"><i class="fa fa-user"></i> Professeur </h3>
         ...
         <div class="form-body">
              ...
              <div class="form-group" >
                   ...
                   <input name="id"  class="form-control" type="Number" placeholder="ID">
                   </div>
            ...
            <div class="form-group" >
              ...
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="cin"  class="form-control" type="text" placeholder="CIN">
                   </div>
                   <span class="help-block" id="error"></span>
              </div> 
		<div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="tel"  class="form-control" type="Number" placeholder="Telephone">
                   </div>
                   <span class="help-block" id="error"></span>
              </div> 
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="matiere_ens"  class="form-control" type="text" placeholder="Matiere Enseignee">
                   </div>
                   <span class="help-block" id="error"></span>
              </div> 
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="password"  class="form-control" type="Number" placeholder="Password">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>   
