...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
      ...
      $q2 = 'update Module set coefficient = "'.$_POST['coefficient'].'" where Num_Module="'.$_GET['id'].'" ';
      $r2 = $db ->query($q2); 
 header('location:modifier_module.php?id='.$_GET['id'].'');   
echo '<div class="alert bg-success" role="alert">
          <svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Votre coefficient est bien modifié! <a href="#" class="pull-right"></a>
        </div>'; 
 } 
}
...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
      ...
      $q2 = 'update Module set Annee_scolaire = "'.$_POST['Annee_scolaire'].'" where Num_Module="'.$_GET['id'].'" ';
      $r2 = $db ->query($q2); 
 header('location:modifier_module.php?id='.$_GET['id'].'');   
echo '<div class="alert bg-success" role="alert">
          <svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Votre annee scolaire est bien modifié! <a href="#" class="pull-right"></a>
        </div>'; 
 } 
}
?>
...
<div class="col-md-10">
      <br><br>
		...
		<tr>
              <td> <label><center>Coefficient:</center> </label></td>
              <td> <input class="form-control" name="coefficient" type="text" value="<?php echo $c['coefficient'];?>"></td>
              <td><button type="submit" class="btn btn-primary" name="btn3">changer</button> </td>
              </tr>
		<tr>
              <td> <label><center>Annee Scolaire:</center> </label></td>
              <td> <input class="form-control" name="Annee_scolaire" type="text" value="<?php echo $c['Annee_scolaire'];?>"></td>
