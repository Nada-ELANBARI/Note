...
<?php
 ...
 $q = "select count(*) as nbr from corps where id_user = '".$_POST['user']."' and password = '".($_POST['password'])."'";
	$r = $db -> query($q);
	$c = $r -> fetch();

    $q1 = "select * from corps where id_user = '".$_POST['user']."' and password = '".($_POST['password'])."'";
	$r1 = $db -> query($q1);
	$c1 = $r1 -> fetch();
    $id_user = $c1['id_user'] ;
