...
echo '<div class="alert bg-danger" role="alert">
 ...
 }else
 {
  ...
  $sql2 = 'INSERT INTO eleves VALUES ("'.$_POST['id'].'","'.$_POST['nom'].'","'.$_POST['prenom'].'","'.$_POST['niveau'].'","'.$_POST['password'].'")'; 
 
 $db->exec($sql2);        
 
echo '<div class="alert bg-success" role="alert">
          <svg class="glyph stroked checkmark"><use xlink:href="#stroked-checkmark"></use></svg> Votre eleve est bien enregistrer! <a href="#" class="pull-right"></a>
        </div>'; 
 } 
}
...
?>
         ...
         <div class="form-header " >
         	<h3 class="form-title"><i class="fa fa-user"></i> Eleve </h3>
		...
		<div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="niveau"  class="form-control" type="text" placeholder="Niveau">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>  
              <div class="form-group" >
